...
This Historians are quite pixelated again. This time, a massive, black building looms over you - you're [right outside](https://adventofcode.com/2017/day/24) the CPU!
...
In this example, the total number of cheats (grouped by the amount if time they save) are as follows:
...
To begin, [get your puzzle input](https://adventofcode.com/2024/day/20/input).

## Part Two

The programs seem perplexed by your list of cheats. Apparently, the two-picosecond cheating rule was deprecated several milliseconds ago! The latest version of of the cheating rule permits a single cheat that instead lasts at most **20 picoseconds**.
