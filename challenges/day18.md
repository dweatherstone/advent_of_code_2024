...
To begin, [get your puzzle input](https://adventofcode.com/2024/day/18/input).
...
So, in this example, the coordinate of the first byte that prevents the exit from being reachable are **`6,1`**.
